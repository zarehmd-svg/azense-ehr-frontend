...
const PATIENT_CHIEF_COMPLAINTS_EHR = {
  ...
  "2": "Acute respiratory failure secondary to COPD exacerbation",
  "3": "Acute decompensated heart failure with volume overload and cardiorenal syndrome",
  "4": "Acute chest pain with troponin elevation concerning for NSTEMI",
  "5": "Septic shock secondary to community-acquired pneumonia with acute hypoxemic...",
  "6": "Acute decompensated heart failure with severe volume overload and respiratory distress",
  "7": "Acute STEMI (de Winter T-wave pattern, proximal LAD)",
  "8": "Crescendo chest pain with troponin elevation consistent with NSTEMI — admitted for...",
  "9": "Diabetic ketoacidosis — new diagnosis type 1 diabetes mellitus with severe metabolic...",
  "10": "Hyperosmolar Hyperglycemic State (HHS) with altered mental status",
  "11": "Acute ischemic stroke of the left middle cerebral artery territory with right-sided...",
  "12": "Acute spontaneous intracerebral hemorrhage — left basal ganglia with intraventricular...",
  "13": "Acute hypoxic respiratory failure requiring emergent intubation with severe acute...",
  "14": "Acute anaphylaxis secondary to peanut exposure with anaphylactic shock, angioedema...",
  "15": "Sepsis secondary to urinary tract infection in 92-year-old with multiple...",
  ...
  "21": "Acute chest pain with intermediate HEART score (6), rule out ACS with observation and...",
  "22": "Progress note hospital day 2 for patient with chest pain and positive nuclear stress...",
  "23": "Septic shock with acute hypoxemic respiratory failure in neutropenic patient on...",
  "24": "Septic shock with acute hypoxemic respiratory failure in neutropenic patient on...",
  ...
  "31": "Fever, right flank pain, and chills x 1 day",
  "32": "Rapidly spreading redness and warmth of right lower leg with fevers for 2 days",
  "33": "4 days of watery diarrhea, abdominal cramping, and low-grade fevers after recent...",
  ...
  "36": "Brief loss of consciousness in a hot crowded concert venue with prodromal nausea and...",
  "37": "Multiple episodes of large-volume bright red hematemesis with lightheadedness",
  "38": "2 days of severe pain, swelling, and erythema of right first MTP joint — unable to...",
  "39": "3-week-old plantar foot ulcer with spreading erythema, swelling, and foul-smelling...",
  "40": "Tremors, anxiety, palpitations, and nausea 24 hours after last drink",
  "41": "2 days of acute worsening confusion, visual hallucinations, and agitation in patient...",
  "42": "Outpatient lab result showing potassium 6.5 mEq/L; asymptomatic; EKG changes",
  "43": "Fatigue, dizziness, unsteady gait, and mild confusion — 5 days",
  ...
  "53": "Worsening dyspnea and somnolence in a patient with severe COPD",
  ...
  "56": "Actively seizing for over 5 minutes without regaining consciousness; missed seizure...",
  ...
  "62": "Unresponsive, found by assisted living staff — extreme cold, bradycardia",
  "63": "Fever, extreme agitation, rapid heart rate, shortness of breath",
  "64": "Confusion, polyuria, constipation, and proximal muscle weakness; markedly elevated calcium",
  "65": "Nausea, decreased urine output, weakness, and muscle cramps 2 days after starting...",
  "66": "Fever 38.9°C in setting of chemotherapy — 12 days post-FOLFOX Cycle 3",
  "67": "Nausea, vomiting, abdominal pain, Kussmaul respirations, and altered mental status;...",
  "68": "Sudden dyspnea, right pleuritic chest pain, and syncope; hypotensive — bilateral...",
  "69": "Profound confusion, left-sided weakness, and slurred speech; glucose 1100 mg/dL",
  "70": "Persistent agitation, confusion, and disorientation on Day 5 of ICU stay following...",
  "71": "Increasing confusion, asterixis, and somnolence in a patient with cirrhosis (Child-Pugh C)",
  "72": "Diffuse abdominal pain, low-grade fevers, and worsening ascites in a patient with...",
  "73": "Atypical chest discomfort and progressive dyspnea; elevated troponin with lateral ST...",
  "74": "Exertional chest discomfort, progressive dyspnea, and syncopal episode while climbing...",
  "75": "Fevers, malaise, pleuritic chest pain, and cough in a patient with IV drug use and a...",
  "76": "Several weeks of progressive dyspnea, nonproductive cough, and weight loss in...",
  "77": "Worsening bilateral leg edema, orthopnea, and dyspnea on exertion despite doubling...",
  "78": "Sudden-onset pleuritic right chest pain and dyspnea in patient with metastatic breast...",
  "79": "Increased sputum volume and purulence with worsening dyspnea x4 days",
  "80": "Severe dyspnea, hypotension, tachycardia, and altered mental status with bilateral...",
  "81": "Three days of melena, lightheadedness, and orthostatic dizziness while on apixaban for...",
  "82": "Palpitations, weight loss, tremor, and heat intolerance with atrial fibrillation with...",
  "83": "Black stools and profound fatigue in a dialysis patient",
  "84": "Rapidly progressive bilateral leg weakness, lower extremity numbness, and urinary...",
  "85": "Crampy left lower quadrant pain and bloody diarrhea 12 hours after post-procedure...",
  "86": "Sudden severe headache, vomiting, and right-sided weakness; left basal ganglia...",
  "87": "Cardiac arrest — Torsades de Pointes / Polymorphic Ventricular Tachycardia",
  "88": "Severe dyspnea, inability to speak full sentences, accessory muscle use after viral URI",
  "89": "Pulmonary embolism — 28 weeks gestation",
  "90": "Massive right pleural effusion — suspected malignant",
  "91": "Fevers, chills, malaise, and a new murmur in a patient with mechanical aortic valve",
  "92": "Sickle cell disease (HbSS) — vaso-occlusive crisis (VOC), severe",
  "93": "Acute chest syndrome (ACS) — sickle cell disease HbSS",
  "94": "Oozing from IV sites, petechiae, thrombocytopenia, and prolonged PT/INR in septic shock",
  "95": "Ventricular tachycardia storm — ischemic cardiomyopathy, 8 appropriate ICD shocks",
  "96": "Wernicke encephalopathy — alcohol use disorder",
  "97": "Epigastric pain radiating to back and vomiting; markedly elevated triglycerides",
  "98": "Exertional rhabdomyolysis — military training",
  "99": "Urosepsis — obstructing left ureteral calculus with pyonephrosis",
